                ...
                <div>
                    <div className="card-card flex flex-col items-center w-96 rounded-2xl" >
...

                        {
                            ...
                            (<Button onClickCapture={() => onConnect()} className="joyid-button" aria-describedby={id} variant="contained" onClick={handleClick}>
                                Connect JoyID
                            </Button>)
                        }
                        {
                    ...
                    <div className="card-card flex flex-col items-center w-96 rounded-2xl" >
                        ...
                        <div className="flex connect-main">
                            <Btn className="connect-neuron-button" disabled={!joyid_account}>
